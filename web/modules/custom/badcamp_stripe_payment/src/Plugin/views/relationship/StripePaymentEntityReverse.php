...
namespace Drupal\badcamp_stripe_payment\Plugin\views\relationship;
 ...
 *
 * @ViewsRelationship("stripe_payment_entity_reverse")
 */
class StripePaymentEntityReverse extends EntityReverse {
